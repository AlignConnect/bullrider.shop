...
const Formdata = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Bullrider.shop/BRA");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);

            formdata.append("blog_url", process.env.NEXT_APP_URL_BRA ?? "bullrider.shop");
    ...
    return (<div className="bg-[#F8F4E1]    p-2" id="buynow">
        ...
        <h1 className="text-2xl sm:text-3xl text-center  text-black font-extrabold px-2 pt-3  md:pt-7">
