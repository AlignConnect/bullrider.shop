...
export default function Document() {
  return (
    <Html lang="en">
      <title>Bull Rider Capsule</title>
      <Head>
        ...
        <Script
          strategy="lazyOnload"
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-W6HS3PMW61"
        ></Script>
  ...
  gtag('config', 'G-W6HS3PMW61');`}
        ...
        (function(w,d,s,l,i){w[l] = w[l] || [];w[l].push({'gtm.start':
          ...
          })(window,document,'script','dataLayer','GTM-PLHLJX3C');
        `}
        </Script>
        {/* <Script strategy="lazyOnload">
          {`
        ...
        })(window, document, "clarity", "script", "m9z6iej16p");
                `}
        </Script> */}
        <Script
          strategy="lazyOnload"
        ...
        <Script
          strategy="lazyOnload"
          src={`https://www.facebook.com/tr?id=3453205531479846&ev=PageView&noscript=1`}
        />
        ...
        <Script strategy="lazyOnload">
         ...
         !function(f,b,e,v,n,t,s)
          ...
          fbq('init', '3453205531479846');
          fbq('track', 'PageView');
        `}
        </Script>
        <Script strategy="lazyOnload">
          {`window["conversion_code"] = "AW-745078872/yP7RCMyDpO8ZENiApOMC"`}
        </Script>
        ...
        t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i;
        y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);
    })(window, document, "clarity", "script", "p825zsng4y");
                `}
        </Script>
