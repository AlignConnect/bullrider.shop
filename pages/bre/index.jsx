            ...
            return (
                <div className=" bg-[#fff9ef] rounded-xl py-3 mx-2 " key={key}>
                    <img
                        ...
                        alt="benefits_imgs"
                    />
                    <div className=" fontPoppins text-center text-[1rem] md:text-[0.8vw] leading-tight font-semibold md:px-2 pt-2">
                        {e.benefits_content}
                    </div>
                </div>
            );
        ...
        return arr?.map((e, key) => {
            return (
                <div className=" bg-[#fff9ef] rounded-xl py-3 mx-1 my-2 " key={key}>
                    <div className=" fontPoppins text-[#a06103]  text-center text-[1.2rem] md:text-[1.4vw]  font-extrabold ">
                        {e.Ingrediants_title}
                    </div>
                    <img
                        ...
                        alt="benefits_imgs"
                    />
                    <div className=" fontPoppins text-center text-[0.8rem] md:text-sm leading-tight font-semibold md:px-6 pt-2  text-gray-700">
              ...
              >
                BUY NOW
                                ...
                                {all_benefits([
                                    {
                                        ...
                                        benefits_content: "Feeling of enthusiasm and energy throughout the day",
                                    },
                                ])}
                            </div>
                            <div className="">
                                {all_benefits([
                                    {
                                        ...
                                        benefits_content: "Helpful in muscle strength and muscle recovery",
                                    },
                                ])}
                            </div>
                            <div className="">
                                {all_benefits([
                                    {
                                        ...
                                        benefits_content: "Helpful in making marital life happy",
                                    },
                                ])}
                            </div>
                        </Slider>
                    ...
                    <div className="">
                        ...
                        <div className="">
                            <ul className="list-disc fontPoppins ml-5 text-md">
                                <li>One capsule in morning and after dinner with milk/water</li>
                                <li>For better result take with 1 glass of milk</li>
                            </ul>
                        </div>
                        ...
                        <p className="text-[#a06103] fontNoto font-extrabold py-3">
                            Try Bull Rider Capsule today and take your energy levels to a higher level!
                        </p>

                        <p className="fontNoto  text-justify">
                            By consuming it, you can feel strong and energetic throughout the day. It will help in fulfilling the high energy required for tough gym workouts and will get rid of early fatigue. Not only this, its powerful ingredients have been proven to be useful in muscle strength and post-workout muscle recovery.
                        </p>
