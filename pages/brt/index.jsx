...
//   import("@/pages/commonUse/bigbillion/Bigtaboola")
// );
...
// const index = () => {
//   useEffect(() => {
//     localStorage.setItem("PATH", "bullrider.shop/brt");
//   }, []);
...
const Footer = dynamic(() => import("./old_component_backup/Footer"), {
  loading: () => <p>Loading...</p>,
});
...
const product_data = [
  {
    type: "image",
    src: "https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/5287cfe7-d246-4e2a-ecc6-d5cd80300400/public",
  },
  {
    type: "image",
    src: "https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/ae87bc3c-2a89-4311-fb8b-4b5d29f0a400/public",
  },
  {
    type: "image",
    src: "https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/38dd4f80-1dbc-4b95-4cae-9a2e1143a900/public",
  },
  {
    type: "iframe",
    src: "https://www.youtube.com/embed/pTE4dr5C_Bo?si=I3TJkOi6o0nVRHay",
  },
];
const settings_p_m = {
  ...
  return (
    <div className="bg-zinc-500">
      ...
      <div className=" sm:max-w-xl w-full mx-auto bg-white fontPoppins">
        <div className="fontNoto bg-zinc-900 text-center text-white pt-2 text-sm sm:text-md ">*विज्ञापन-संबंधी</div>
        ...
        <div className=" px-3 sm:px-5">
          <div className=" grid ">
            <h2 className="fontPoppins text-3xl md:text-[2vw] font-extrabold text-gray-900 pt-3  mt-3">
              {/* {products?.title} */}
              Bull Rider Capsule
            </h2>
            ...
            {/* <div className="">
              <div className="grid grid-cols-1 items-center gap-3 py-3 mt-2 selectedItem ">
                  ...
                  return (
                    ...
                    >
                      <input
                        ...
                        // hidden
                      />{" "}
                      {variant.title} ₹{parseInt(variant?.price)} (
                      {parseInt(
            ...
            <div id="buynow" className="grid grid-cols-1 items-center py-3 mt-2 selectedItem ">
              {allVariants?.map((variant, key) => {
                return (
                  ...
                  >
                    {key === 1 && (
                      <div className="absolute top-0 left-0 bg-[#df7700] px-1 rounded-ss-lg z-10 text-white">
                        Most popular
                      </div>
                    )}
                    <div
        ...
        />
          ...
          <div className="py-2">
            <div className="text-sm  pt-4 text-black">We accept payment via-</div>
            <img
          ...
          <div className="text-center mt-3 sm:pb-0 pb-16">
            <img
