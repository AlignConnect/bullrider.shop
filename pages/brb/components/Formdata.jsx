...
const Formdata = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Bullrider.shop/BRB");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);

            formdata.append("blog_url", process.env.NEXT_APP_URL_BRB ?? "bullrider.shop");
    ...
    return (<div className="bg-white   p-2" id="buynow">
        ...
        <h1 className="text-2xl sm:text-3xl text-center  text-black font-extrabold px-2 pt-5  md:pt-7">
        ...
        <div className={`pb-4 text-black ${poppin.className}`} id='formcallhide'>
            <div className="form_shaddow max-w-2xl md:mx-auto p-3 md:p-6 bg-[#2a2a2a] rounded-xl border border-solid border-white my-4">
                <div className="py-4 ">
